...
@Component({
  selector: 'atlas-input-only-example',
  templateUrl: './input-only-example.component.html',
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class InputOnlyExampleComponent extends NgxObservableViewModel<ViewModel, FormControlSubject, ViewModelSubjectModel> {
  constructor() {
    super({
